...
Available disk sizes: 0, 25, 50, 100, 250, 500, 1000, 2000 GB`,
	Example: `  cloudamqp instance resize-disk 1234 --disk-size=100
  cloudamqp instance resize-disk 1234 --disk-size=250 --allow-downtime`,
...
func init() {
	...
	instanceResizeCmd.ValidArgsFunction = completeInstances
}
